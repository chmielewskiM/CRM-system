        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Conversion = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SaleProcess", x => new { x.ContactId, x.OperationId });
                    table.ForeignKey(
                        name: "FK_SaleProcess_Contacts_ContactId",
                        column: x => x.ContactId,
                        principalTable: "Contacts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SaleProcess_Operations_OperationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleProcess_OperationId",
                table: "SaleProcess",
                column: "OperationId",
                unique: true);
